...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:365px;left:479px;"> 
  ...
  <column name="fRootID" type="String" xid="xid2"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content" xid="content1"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list3" data="threeClassData">
   <ul class="x-list-template" xid="listTemplateUl3">
    <li xid="li3" class="col-xs-3"><div class="media" xid="media2">
   <div class="media-top" xid="mediaLeft2">
    <a href="#" xid="a2">
     <img class="media-object" src="" alt="" xid="image3" bind-attr-src=' val("fImg")' style="width:40px;"></img></a> </div> 
